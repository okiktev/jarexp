...
class StatusBar extends JStatusBar {
	...
	private static final long serialVersionUID = -9182342979593830444L;

	private JProgressBar progressBar = new JProgressBar();
	private final MtoolPanel content;
	private final JLabel path = new JLabel("");
	private final JLabel children = new JLabel("");

	StatusBar(MtoolPanel content) {
		super();
		this.content = content;

		children.setToolTipText("Number of all objects placed in current folder");
